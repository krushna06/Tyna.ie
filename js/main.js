! function(e) {
	...
	if (e(window).on("load", (function() {
			...
			return this.each((function() {
				...
				e(n).each((function() {
					e(this).on("click", (function(t) {
						var s, n, o;
						t.preventDefault(), s = e(this).parent(), n = e(s).parent(), (o = n.siblings()).removeClass(a.subMenuParentToggle), o.find("ul").slideUp(a.toggleSpeed).removeClass(a.subMenuToggleClass), n.toggleClass(a.subMenuParentToggle), e(s).next("ul").slideToggle(a.toggleSpeed).toggleClass(a.subMenuToggleClass)
					}))
	...
	function p() {
		...
		(function() {
			...
			s('[name="name"],[name="email"],[name="subject"],[name="number"],[name="message"]'), e(l).val() && e(l).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(l).removeClass("is-invalid"), a = !0) : (e(l).addClass("is-invalid"), a = !1);
			return a
		})() && jQuery.ajax({
			url: e(c).attr("action"),
			data: t,
			...
			d.removeClass("error"), d.addClass("success"), d.text(t), e(c + ' input:not([type="submit"]),' + c + " textarea").val("")
		})).fail((function(e) {
	...
	e(c).on("submit", (function(e) {
	...
	})), u(".sidemenu-cart", ".sideMenuCart", ".sideMenuCls", "show"), u(".sidemenu-info", ".sideMenuInfo", ".sideMenuCls", "show"), e(".popup-image").magnificPopup({
		type: "image",
		...
		e(this).each((function() {
			var s, n, o, i, r, c = e(this);
			s = Math.floor(c.height() / 2), n = c.attr(t), o = c.attr(a), i = h(e(o).css("padding-top")), r = h(e(o).css("padding-bottom")), "top-half" === n ? (e(o).css("padding-bottom", r + s + "px"), c.css("margin-top", "-" + s + "px")) : "bottom-half" === n && (e(o).css("padding-top", i + s + "px"), c.css("margin-bottom", "-" + s + "px"))
		}))
	};
	...
	}, e(".shape-mockup") && e(".shape-mockup").shapeMockup(), m(), e(window).scroll(m), e(".progress-bar").waypoint((function() {
		e(".progress-bar").css({
